...
\includegraphics[scale=0.3]{meetndo/pics/mockups/Chatroom.png}

\subsubsection{MyMeetings User Meeting page} \hspace{10cm}

\includegraphics[scale=0.3]{meetndo/pics/mockups/Mymeetings.png}

\subsubsection{Public Profile page} \hspace{10cm}

\includegraphics[scale=0.3]{meetndo/pics/mockups/PublicProfile.png}

\subsubsection{Private Profile page} \hspace{10cm}

\includegraphics[scale=0.3]{meetndo/pics/mockups/PrivateProfile.png}
